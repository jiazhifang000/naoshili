package com.naoshili.common.exception;
...
import com.naoshili.common.utils.HttpServletUtils;
...
public class BDExceptionHandler {
	...
	// public R
	// noHandlerFoundException(org.springframework.web.servlet.NoHandlerFoundException
	// e) {
	// logger.error(e.getMessage(), e);
	...
	public Object handleException(Exception e, HttpServletRequest request) {
		...
		/*
		 * if (null != current) { logDO.setUserId(current.getId());
